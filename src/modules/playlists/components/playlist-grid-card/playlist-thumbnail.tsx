...
export const PlaylistThumbnail = ({ imageUrl, title, videoCount, className }: PlaylistThumbnailProps) => {
  return (
    <div className={cn("relative pt-3 group", className)}>
      ...
      <div className="relative">
        ...
        <div className="relative overflow-hidden w-full rounded-xl aspect-video">
          ...
          <div className="absolute inset-0 bg-black/70 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
            <div className="flex items-center gap-x-2 group-hover:bg-white/10 p-4 rounded-xl">
      ...
      <div className="absolute bottom-2 right-2 px-1 py-0.5 rounded ng-black/80 text-white text-xs font-medium flex items-center gap-x-1">
