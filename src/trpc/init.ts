...
export const createTRPCRouter = t.router;                             // Función helper para crear instancias de routers tRPC. Estos routers llaman a procedimientos tRPC.
export const createCallerFactory = t.createCallerFactory;             // Función para generar "callers". Un caller te permite ejecutar procedimientos tRPC directamente en el backend, sin necesidad de una solicitud HTTP.
export const baseProcedure = t.procedure;                             // Función helper (base) para definir procedimientos tRPC base. Un procedimiento es una función que se ejecuta en el servidor cuando el cliente hace una solicitud.  
